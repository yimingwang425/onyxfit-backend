...
import { formatApplicationToExport, formatApplicationsToExport, } from './converters/exporters/applications/jhipster-application-formatter.js';
 ...
 */
export function createImporterFromFiles(files, configuration, definition) {
    if (!files) {
 ...
 */
export function createImporterFromContent(jdlString, configuration, definition) {
    if (!jdlString) {
...
function makeJDLImporter(content, configuration, runtime) {
    let importState = {
...
function getJDLObject(parsedJDLContent, configuration, runtime) {
