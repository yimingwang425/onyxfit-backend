 ...
 */
export function parseFromConfigurationObject(configurationObject, runtime) {
...
function fillApplications(runtime) {
    // TODO: Function which expects two arguments is called with three.
    const jdlApplications = convertApplications(parsedContent.applications, runtime);
