 ...
 */
export declare function displayObjectDeprecationMessage({ deprecatedObject, preferredObject, }: {
 ...
 * @param deprecationNoticeObject The configuration
 */
export declare function displayMethodDeprecationMessage({ deprecatedMethod, preferredMethod, }: {
