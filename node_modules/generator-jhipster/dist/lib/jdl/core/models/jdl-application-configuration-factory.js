...
export default function createApplicationConfigurationFromObject(configurationObject = {}, runtime) {
    ...
    Object.keys(configurationObject).forEach(optionName => {
        ...
        if ((Array.isArray(optionValue) || typeof optionValue === 'string') &&
...
export function createApplicationNamespaceConfigurationFromObject(parsedNamespaceConfigs = {}, runtime) {
...
function createUnknownJDLConfigurationOption(name, value, runtime) {
    let type;
...
function createApplicationJDLConfigurationOption(name, value, runtime) {
    const type = runtime.applicationDefinition.getTypeForOption(name);
    return createJDLConfigurationOption(type, name, value, runtime);
}
function createJDLConfigurationOption(type, name, value, runtime) {
    switch (type) {
        case 'string':
            return new StringJDLApplicationConfigurationOption(name, value, runtime.applicationDefinition.shouldTheValueBeQuoted(name));
        case 'integer':
