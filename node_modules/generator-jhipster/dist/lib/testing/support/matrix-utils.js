...
export const fromMatrix = (configMatrix) => {
    ...
    const samples = configEntries.reduce((previousValue, currentValue) => {
        ...
        return previousValue
            .map(([previousName, previousConfig]) => configValues.map(value => {
            return [
...
const applyExtendedMatrix = (matrixEntries, configMatrix) => {
    const configEntries = Object.entries(configMatrix);
    const additionalMatrixTemp = configEntries.reduce((currentArray, [configName, configValues]) => {
...
export const buildSamplesFromMatrix = (samples, { commonConfig = {} } = {}) => sortKeys(commonConfig
    ? Object.fromEntries(Object.entries(samples).map(([name, sample]) => [
        name,
        {
            ...sample,
            ...commonConfig,
