...
export default class JibGenerator extends BaseApplicationGenerator {
    ...
    get postWriting() {
        return this.asPostWritingTaskGroup({
            addJibPlugin({ application, source }) {
                ...
                const { cacheProviderHazelcast, cacheProviderInfinispan } = application;
    ...
    <container>
        ...
        <ports>
            <port>${serverPort}</port>${cacheProviderHazelcast
                                ? `
            <port>5701/udp</port>
`
                                : ''}
        </ports>
        <environment>${cacheProviderInfinispan
                                ? `
...
`
    ...
    </extraDirectories>${application.backendTypeSpringBoot
                                ? `
    <pluginExtensions>
        <pluginExtension>
...
`
                                : ''}
</configuration>${application.backendTypeSpringBoot
                                ? `
<dependencies>
    <dependency>
