...
export declare const getCacheProviderMavenDefinition: (cacheProvider: string, javaDependencies: Record<string, string>) => CacheProviderDependencies;
export {};
