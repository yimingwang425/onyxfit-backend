...
export default class BootstrapGenerator extends BaseGenerator {
    ...
    async commitSharedFs({ log, ...options } = {}, ...transforms) {
        ...
        if (!this.skipPrettier) {
            ...
            if (!this.skipEslint) {
                prettierTransforms.push(createESLintTransform.call(this, { ignoreErrors }), createRemoveUnusedImportsTransform.call(this, { ignoreErrors }));
            }
            prettierTransforms.push(await createPrettierTransform.call(this, {
                ignoreErrors,
