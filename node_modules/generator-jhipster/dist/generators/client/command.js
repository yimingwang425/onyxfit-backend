...
import { APPLICATION_TYPE_GATEWAY, APPLICATION_TYPE_MICROSERVICE, clientFrameworkTypes, testFrameworkTypes, } from '../../lib/jhipster/index.js';
...
const command = {
    ...
    configs: {
        ...
        microfrontends: {
            ...
            cli: {
                type: (val) => promptValueToMicrofrontends(val),
            },
            prompt: ({ jhipsterConfigWithDefaults: config }) => ({
                when: answers => {
